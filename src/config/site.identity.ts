export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'lesflicksplus',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Lesflicksplus',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'lesflicksplus.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://lesflicksplus.com',
